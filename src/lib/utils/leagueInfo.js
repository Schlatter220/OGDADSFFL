/*   STEP 1   */
export const leagueID = "1259289618780540928"; // your league ID
...
export const managers = [
   {
      "Zyn N' Whiskey": 1,  // (DEPRECATED! Don't use this anymore) ID of the roster that the manager manages (look at the order of the power rankings graph)
      ...
      "philosophy": "When in doubt pull your wiener out", // (optional)
